...
class JobApplication(http.Controller):
    ...
    def render_job_personal_form(self, **kw):
        ...
        return request.render('egp_hr_org_structure.personal_information_form_template', {'applicants': applicants})
...
class ApplicantController(http.Controller):
    ...
    def submit_applicant(self, **post):
        ...
        return request.render('egp_hr_org_structure.success_message_form_template')
